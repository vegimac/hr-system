...
public class DocumentsController : ControllerBase
{
    ...
    public async Task<IActionResult> PreviewPdf(int id)
    {
        ...
        if (ext == ".pdf" || doc.MimeType == "application/pdf")
        {
            ...
            Response.Headers["Content-Disposition"] =
                ContentDispositionUtil.Build("inline", doc.FilenameOriginal, "dokument.pdf");
    ...
    private async Task<IActionResult> ServeFile(int id, bool asAttachment)
    {
        ...
        Response.Headers["Content-Disposition"] =
            ContentDispositionUtil.Build(contentDisposition, doc.FilenameOriginal, "dokument");
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        if (await _db.WeitereArbeitgeber.AnyAsync(a => a.ErlaubnisDokumentId == id))
            blockers.Add("Erlaubnis Hauptarbeitgeber");
