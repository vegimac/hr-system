...
public class BewerbungsgespraechController : HrControllerBase
{
    ...
    private static readonly (string Sektion, string Key, string Label)[] Katalog =
    {
        ...
        ("Personalien", "ahv_fehlt", "Noch keine AHV-Nummer (bestellen)"),
        ...
        ("Einsatz & Onboarding-Tag", "pensum", "Gewünschtes Pensum (%)"),
        ("Einsatz & Onboarding-Tag", "eintritt", "Frühester Eintritt"),
        ("Einsatz & Onboarding-Tag", "erfahrung", "Erfahrung in Gastronomie"),
        ("Einsatz & Onboarding-Tag", "willkommenstag_teilnahme", "Onboarding-Tag Teilnahme"),
        ("Einsatz & Onboarding-Tag", "willkommenstag_termin", "Gewünschter Onboarding-Tag"),
        ("Einsatz & Onboarding-Tag", "eintritt_vereinbart", "Arbeitsbeginn"),
        ("Gesundheit", "krankheit", "Gesundheitlich / Allergien zu berücksichtigen"),
        ("Gesundheit", "krankheit_welche", "Auf was müssen wir achten"),
