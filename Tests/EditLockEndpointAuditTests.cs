...
public class EditLockEndpointAuditTests
{
    ...
    private static readonly Dictionary<string, string> LOCK_IRRELEVANT_CONTROLLERS = new()
    {
        ...
        ["EmployeeZivilstandController"]   = "Zivilstand-Historie (Stammdaten mit Gültig-ab) — keine Lohndaten, QST-Versionen unberührt (Walter 04.09.2026)",
        ["LoginGreetingController"]        = "Programmbegrüssung auf der Anmeldeseite (Texte pro Tageszeit) — reine Einstellung, keine Lohndaten (Walter 04.09.2026)",
