...
public class AhvAnmeldungPdfService
{
    ...
    public byte[] Generate(AhvAnmeldungData d)
    {
        ...
        using (var pdf = new PdfDocument(reader, writer))
        {
            ...
            // Werte-Grundlinien EXAKT aus den Box-Linien des Templates vermessen
            // (Walter-Feedback 06.08.2026 v2): baseline = BoxTop + (BoxHöhe 16.8
            // + CapHeight 7.2) / 2 = BoxTop + 12.0 → Text vertikal mittig.
            T1(d.Wohnsitzland, 40, 158.8f);
            // Grenzgänger: Kreis vor «ja» (x0 48.6) bzw. «nein» (x0 69.0)
            if (d.Grenzgaenger) X1(40.0f, 190.5f); else X1(60.5f, 190.5f);
            T1(d.Name,         40, 229.7f);
            T1(d.Ledigname,    40, 264.3f);
            T1(d.Vornamen,     40, 299.0f);
            T1(d.Geburtsdatum, 40, 350.9f);
            T1(d.AhvNummer,   330, 382.4f);   // Grundlinie des vorgedruckten «756»
            ...
            T1(d.Strasse,       40, 503.1f);
            T1(d.HausNr,       432, 503.1f);
            T1(d.Plz,           40, 537.7f);
            T1(d.Ort,          170, 537.7f);
            T1(d.Telefon,       40, 572.4f);
            T1(d.Email,        301, 572.4f);
            T1(d.Staatsangehoerigkeit, 40, 612.3f);
            T1(d.Geburtsort,   316, 612.3f);
            T1(d.MutterName,    40, 697.8f);
            T1(d.MutterVornamen, 40, 744.4f);
            ...
            T2(d.VaterName,     40, 68.0f);
            T2(d.VaterVornamen, 40, 114.6f);
            ...
            T2(d.GrundText,     40, 274.1f);
            T2(d.Firmenname,    40, 354.4f);
            T2(d.Abrechnungsnummer, 388, 354.4f);
            T2(d.FirmaStrasse,  40, 389.1f);
            T2(d.FirmaHausNr,  432, 389.1f);
            T2(d.FirmaPlz,      40, 423.7f);
            T2(d.FirmaOrt,     170, 423.7f);
            T2(d.Stellenantritt, 40, 458.4f);
