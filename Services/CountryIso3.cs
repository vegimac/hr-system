...
/// <summary>
/// ISO-3166: alpha-2 → alpha-3 (Walter-Vorgabe 12.07.2026). Die Schweizer
/// Ausländerausweise drucken den DREIbuchstaben-Code (BGR, MKD, ESP …),
/// unser System führt alpha-2 (nationality.code). Diese statische Tabelle
/// seedet beim Server-Start idempotent die Spalte nationality.code3
/// (nur wo leer) — Anzeige in den Nationalitäts-Dropdowns als «MK / MKD».
/// Kosovo (XK) hat keinen offiziellen ISO-alpha-3-Code — auf den Pässen/
/// Ausweisen steht «RKS»; bei Bedarf in der DB (code3) anpassbar.
/// </summary>
public static class CountryIso3
{
    public static readonly IReadOnlyDictionary<string, string> ByAlpha2 = new Dictionary<string, string>
    {
        ...
        ["VN"] = "VNM", ["VU"] = "VUT", ["WF"] = "WLF", ["WS"] = "WSM", ["XK"] = "RKS", ["YE"] = "YEM",
