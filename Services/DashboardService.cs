    ...
    public async Task<DashboardData> BuildAsync(int? companyProfileId)
    {
        ...
        // MA, das Erfassen entfernt die Warnung sofort.
        {
            ...
            foreach (var emp in nwExam)
            {
                ...
                // Getrennte Kategorien (Walter 31.07.2026 / Kritisch 03.08.2026):
                ...
                //  • night_work_ausnahme_fehlt  — nur Ausnahmeregelung fehlt → Kritisch
                ...
                void MeldeAusnahmeFehlt()
                {
                    ...
                    alerts.Add(new DashboardAlert
                    {
                        ...
                        Severity = SeverityState("night_work_ausnahme_fehlt", "critical"),
