...
using (var scope = app.Services.CreateScope())
{
    ...
    db.Database.ExecuteSqlRaw(@"
        ...
        -- Unterschrift Erziehungsberechtigte bei MA unter 18 (Walter 23.09.2026)
        ALTER TABLE employment ADD COLUMN IF NOT EXISTS unterschrift_eltern BOOLEAN NOT NULL DEFAULT false;
