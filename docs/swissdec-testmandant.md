...
- Schritt 5a: Ferienregelung Muster AG 8.33 % (20 Tage) bis 59, 13.04 % ab 60 (30 Tage). FLEX-Zuschlag folgt dem Alter (TF02 Paganini). 25 Tage ab 50 haben kein eigenes %-Band.
  Monatslohn/Stunden/Zulagen aus wagetypes_export.csv in den Lohnlauf; QST-Jahresmodell
  GE/FR/VD/VS/TI (gebaut 19.09.2026, Formel in `docs/swissdec-abweichungsprotokoll.md` O1;
  Belege dieser Kantone nach Tessin-Reset ab Januar prüfen). Tarifdateien 2024–2026 LU/BE/VD/TI;
  GE/FR/VS bewusst nicht einlesen (Test braucht sie nicht).
