...
| **Formel (Anhang 1)** | **IST** = steuerbar (CH-Tage). **Satz-Lohn** = (Σ periodisch ÷ QST-Tage × 360 + Σ aperiodisch) ÷ 12. **Je Tarifcode ein Topf**; Steuer je Topf = Satz(Code, Satz-Lohn) × Topf **rappengenau**. Gerundet wird **nur der Monatsabzug** auf 5 Rp.; der Rest (kumuliert exakt − abgezogen) läuft im Slip-Feld `jahresRest` in den Folgemonat. |
...
| **5 Rp. (26.09.2026)** | Früher wurde **jeder Topf** auf 5 Rp. gerundet → bis zu 5 Rp. Abweichung im Monat. Über alle 122 Monate der Soll-Tabelle betraf es vier: TF22 Bucher **08** (309.65 statt 309.60) und **09** (388.40 statt 388.45), TF23 Koller **12** (1'014.35 statt 1'014.40), TF34 Rinaldi **09** (99.05 statt 99.10, Jahr 2'739.50 statt 2'739.55). Jetzt: Topf rappengenau, nur der Monatsabzug auf 5 Rp., Rest via `jahresRest` weitergetragen — alle vier stimmen. Tests in `Tests/QstJahresmodellTests.cs`. |
