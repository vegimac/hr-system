...
window.i18n = (function () {
    ...
    const dict = {
        ...
        'dash.cat.exitPendingActive':{ de: 'Austritt steht bevor', en: 'Upcoming exit' },
        ...
        'alert.probation.ends_in_days':   { de: 'Probezeit endet {ende} (in {days} Tagen)',
                                             en: 'Probation ends {ende} (in {days} days)' },
        'alert.probation.ends_today':     { de: 'Probezeit endet heute · {ende}',
                                             en: 'Probation ends today · {ende}' },
        'alert.probation.ends_tomorrow':  { de: 'Probezeit endet morgen · {ende}',
                                             en: 'Probation ends tomorrow · {ende}' },
        'alert.probation.gespraech_offen':{ de: 'Probezeitgespräch offen · {ende}',
                                             en: 'Probation interview open · {ende}' },
        'alert.probation.gespraech_fehlt':{ de: '{name} · fehlt: {fehlt}',
                                             en: '{name} · missing: {fehlt}' },
        'alert.audit.silent':             { de: 'Aktivitäts-Log schreibt nicht mehr',
                                             en: 'Activity log stopped writing' },
        'alert.audit.silent_sub':         { de: 'Letzter Eintrag: {last} · seit {days} Tag(en) keine Protokollierung',
                                             en: 'Last entry: {last} · no logging for {days} day(s)' },
        'dash.cat.auditSilent':           { de: 'Aktivitäts-Log stumm',
                                             en: 'Activity log silent' },
        ...
        'alert.exit.pending_active':      { de: 'Austritt am {date}',
                                             en: 'Exit on {date}' },
        'alert.exit.today':               { de: 'Austritt heute · {date}',
                                             en: 'Exit today · {date}' },
        ...
        'alert.qstPartnerDaten':          { de: 'Ehepartner-Angaben unvollständig (QST) — Lohnlauf gesperrt',
                                             en: 'Spouse details incomplete (withholding tax) — payroll blocked' },
        'alert.qstTarifWarnung':          { de: 'QST-Tarif prüfen (Plausibilität)',
                                             en: 'Check withholding tax tariff (plausibility)' },
        'subtitle.qstTarifWarnung':       { de: '{name} · Personalnr. {empNr} · {grund}',
                                             en: '{name} · Employee no. {empNr} · {grund}' },
        ...
        'subtitle.exitPendingActive':     { de: '{name} · Personalnr. {empNr} · in {days} Tag(en)',
                                             en: '{name} · Personnel #{empNr} · in {days} day(s)' },
        ...
        'subtitle.qstPartnerDaten':       { de: '{name} · Personalnr. {empNr} · {grund}',
                                             en: '{name} · Personnel #{empNr} · {grund}' },
        ...
        'ma.section.otherAddrHint':  { de: '(z.B. Wochenaufenthalt, Korrespondenz, Sozialamt — Hauptadresse oben)',
                                       en: '(e.g. weekly residence, correspondence, social welfare — primary address above)' },
        ...
        'fam.addr.same':            { de: 'Ja — lebt im gleichen Haushalt (Hauptadresse)',
                                       en: 'Yes — lives in the same household (main address)' },
        'fam.addr.extern':          { de: 'Nein — lebt nicht (mehr) im gleichen Haushalt',
                                       en: 'No — no longer lives in the same household' },
        'fam.addr.externHint':      { de: 'Eigener Haushalt / ausgezogen — ohne erfasste Adresse.',
                                       en: 'Own household / moved out — no address on file.' },
