...
window.i18n = (function () {
    ...
    const dict = {
        ...
        'alert.probation.gespraech_offen':{ de: 'Probezeitgespräch offen',
                                             en: 'Probation interview open' },
        'alert.probation.gespraech_fehlt':{ de: '{name} · Probezeit bis {ende} · fehlt: {fehlt}',
                                             en: '{name} · probation until {ende} · missing: {fehlt}' },
