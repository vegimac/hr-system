...
const HELP_PAGES = [
    ...
    { slug: 'dashboard',     title: 'Dashboard & To-dos' },
    { slug: 'mitarbeiter',   title: 'Mitarbeiter' },
    { slug: 'mcadmin',       title: 'McAdmin',                     roles: ['admin', 'superuser', 'user'] },
    { slug: 'vertraege',     title: 'Verträge' },
    { slug: 'lohnlauf',      title: 'Lohnlauf',                    roles: ['admin', 'superuser', 'user', 'buchhaltung'] },
    { slug: 'edit-sperre',   title: 'Edit-Sperre',                 roles: ['admin', 'superuser', 'user', 'buchhaltung'] },
    { slug: 'qst',           title: 'Quellensteuer',               roles: ['admin', 'superuser', 'user', 'buchhaltung'] },
    { slug: 'absenzen',      title: 'Absenzen & Kalender',         roles: ['admin', 'superuser', 'user', 'buchhaltung'] },
    { slug: 'manager-dienstplan', title: 'Manager-Dienstplan',     roles: ['admin', 'superuser', 'user', 'buchhaltung'] },
    { slug: 'austritt',      title: 'Kündigung & Austritt',        roles: ['admin', 'superuser', 'user', 'buchhaltung'] },
    ...
    { slug: 'postfach-ma',   title: 'MA-Postfach',                 roles: ['admin', 'superuser', 'user', 'buchhaltung'] },
    { slug: 'hr-hub',            title: 'HR-Bereich',                  roles: ['admin', 'superuser', 'buchhaltung'] },
    { slug: 'lohnausweis',       title: 'Jahres-Lohnausweis',          roles: ['admin', 'superuser', 'buchhaltung'] },
    { slug: 'lohnabtretungen',   title: 'Lohnabtretungen & Behörden',  roles: ['admin', 'superuser', 'user', 'buchhaltung'] },
    { slug: 'auswertungen',      title: 'Auswertungen & Reports',      roles: ['admin', 'superuser', 'user', 'buchhaltung'] },
    { slug: 'fibu',              title: 'Buchhaltung (Fibu)',          roles: ['admin', 'buchhaltung'] },
    { slug: 'filialen',          title: 'Filialen',                    roles: ['admin', 'superuser'] },
    { slug: 'mindestloehne',     title: 'Mindestlöhne',                roles: ['admin', 'superuser'] },
    { slug: 'easyatwork',        title: 'easy@work',                   roles: ['admin', 'superuser', 'user', 'buchhaltung'] },
    { slug: 'onboarding',        title: 'Neue Filiale importieren',    roles: ['admin'] },
    { slug: 'system',            title: 'System (Admin)',              roles: ['admin'] },
...
const HELP_PAGE_BY_APP_PAGE = {
    ...
    'sollstunden':           'auswertungen',
    'ferien':                'auswertungen',
    'alter-report':          'auswertungen',
    'fluktuation-report':    'auswertungen',
    'exit-survey-report':    'auswertungen',
    'absence-report':        'auswertungen',
    'hr-hub':                'hr-hub',
    'kontrolle':             'hr-hub',
    'lohnausweis':           'lohnausweis',
    'mcadmin':               'mcadmin',
    'ma-email':              'hr-hub',
    'manager-schulungen':    'hr-hub',
    'ferien-planer':         'manager-dienstplan',
    'zwischenverdienst':     'hr-hub',
    'lse-export':            'hr-hub',
    'lohn-abtretungen':              'lohnabtretungen',
    'behoerden':                     'lohnabtretungen',
    'aufforderung-arbeit':           'mitarbeiter',
    'kuendigung':                    'austritt',
    'absenz-kalender':               'absenzen',
    'roster-absence-import':         'absenzen',
    'manager-dienstplan':            'manager-dienstplan',
    'filialen':                      'filialen',
    'mindestloehne':                 'mindestloehne',
    'easyatwork':                    'easyatwork',
...
const HELP_PAGE_BY_EMP_TAB = {
    ...
    'absenzen':       'absenzen',
    'zeiten':         'absenzen',
    'verfuegbarkeit': 'easyatwork',
    'zulagen':        'lohnabtretungen',
    'ktg':            'absenzen',
    'dokumente':      'dokumente',
};
...
function helpContextLabel(ctx) {
    ...
    const pageLabels = {
        ...
        'lohn-abtretungen': 'Lohnabtretungen',
        'behoerden': 'Behörden',
        'aufforderung-arbeit': 'Arbeits Aufforderung',
        'kuendigung': 'Kündigung',
        'filialen': 'Filialen',
        'mindestloehne': 'Mindestlöhne',
        'easyatwork': 'easy@work',
        'absenz-kalender': 'Absenzkalender',
