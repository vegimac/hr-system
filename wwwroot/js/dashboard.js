...
const DASH_CATEGORY_META = {
    ...
    dienstalter_pruefen:    { label: 'Betriebszugehörigkeit',  icon: '📅', color: '#b45309' },
...
function buildTodosPrintHtml(anonym = false) {
    ...
    return `<div class="tp-head"><img class="tp-logo" src="img/onecrew-logo.webp" alt="OneCrew"><h1>To-do-Liste</h1><div class="tp-meta">${_e(branchLbl)} · ${today}${anonym ? ' · anonymisiert (nur Personalnummern)' : ''}</div></div>
