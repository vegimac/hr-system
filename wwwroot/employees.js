...
function showFamilyDetailPopup(memberId) {
    ...
    const html = `
        <div style="position:fixed;inset:0;background:rgba(0,0,0,0.4);z-index:2000;display:flex;align-items:center;justify-content:center" onclick="if(event.target===this)closeFamilyDetailPopup()">
            <div style="background:linear-gradient(165deg,#efe7d8 0%,#eae1cf 50%,#e4dac5 100%);border-radius:14px;width:480px;max-width:92vw;box-shadow:0 12px 48px rgba(0,0,0,0.2);overflow:hidden">
...
function openKtgOverrideModal(employeeId, autoTagessatz100, karenzAbgeschlossen, manuellExisting) {
    ...
    const html = `
        <div id="ktgOvBackdrop" style="position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9000;display:flex;align-items:center;justify-content:center;padding:20px"
            ...
            <div style="background:linear-gradient(165deg,#efe7d8 0%,#eae1cf 50%,#e4dac5 100%);border-radius:12px;width:100%;max-width:520px;box-shadow:0 20px 60px rgba(0,0,0,.3);overflow:hidden">
...
function openEmployeeAddressModal(existing) {
    ...
    modal.innerHTML = `
    <div style="background:linear-gradient(165deg,#efe7d8 0%,#eae1cf 50%,#e4dac5 100%);border-radius:12px;width:100%;max-width:760px;box-shadow:0 20px 60px rgba(0,0,0,0.25);margin:auto">
...
function showInitialPasswordModal(username, password) {
    ...
    overlay.innerHTML = `
        <div style="background:linear-gradient(165deg,#efe7d8 0%,#eae1cf 50%,#e4dac5 100%);border-radius:14px;width:100%;max-width:480px;box-shadow:0 24px 64px rgba(0,0,0,0.28);overflow:hidden">
...
async function openPermitHistoryModal(entryId) {
    ...
    modal.innerHTML = `
        ...
        <div style="background:linear-gradient(165deg,#efe7d8 0%,#eae1cf 50%,#e4dac5 100%);border-radius:14px;max-width:540px;width:100%;max-height:90vh;overflow:auto;padding:22px 24px;flex-shrink:0">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:14px">
