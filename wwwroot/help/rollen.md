...
**user** (GF) — Dashboard, Mitarbeiter (inkl. MA Formulare: Probezeit, Umzug, Face ID, Onboarding-QR), Verträge, Lohn (GF-Schritte), Posteingang, Bewilligungen, Dokumente ablegen/löschen. Verwarnung, Aufhebungsvertrag und Arbeitszeugnis bestellen über McAdmin. Filtert automatisch auf die zugeteilten Filialen. Systemeinstellungen und HR-Abschluss (DTA) bleiben HR/Admin.
