...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Employment>(entity =>
        {
            ...
            entity.Property(e => e.UnterschriftEltern).HasColumnName("unterschrift_eltern");
        ...
        modelBuilder.Entity<ElmStammdaten>(entity =>
        {
            ...
            entity.Property(e => e.UvgVersichererNummer).HasColumnName("uvg_versicherer_nummer").HasMaxLength(40);
            ...
            entity.Property(e => e.UvgzVersichererNummer).HasColumnName("uvgz_versicherer_nummer").HasMaxLength(40);
            ...
            entity.Property(e => e.KtgVersichererNummer).HasColumnName("ktg_versicherer_nummer").HasMaxLength(40);
            ...
            entity.Property(e => e.BvgVersichererNummer).HasColumnName("bvg_versicherer_nummer").HasMaxLength(40);
        ...
        modelBuilder.Entity<Absence>(entity =>
        {
            ...
            // Walter-Vorgabe 30.06.2026 / Fix 31.07.2026: Lokalzeit + timestamp
            // without time zone. Ohne HasColumnType mappt Npgsql 8 DateTime als
            // timestamptz und lehnt DateTime.Now (Kind=Local) ab → 500 beim Speichern.
            entity.Property(e => e.CreatedAt).HasColumnName("created_at")
                .HasColumnType("timestamp without time zone");
            entity.Property(e => e.UpdatedAt).HasColumnName("updated_at")
                .HasColumnType("timestamp without time zone");
        ...
        {
            entity.ToTable("interview_fenster");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.EmployeeId).HasColumnName("employee_id");
            entity.Property(e => e.Datum).HasColumnName("datum");
        ...
        modelBuilder.Entity<HrInterviewBuchung>(entity =>
        {
            ...
            entity.Property(e => e.MaAntwortAm).HasColumnName("ma_antwort_am")
                  .HasColumnType("timestamp without time zone");
            entity.Property(e => e.KandidatId).HasColumnName("kandidat_id");
            entity.Property(e => e.OnboardingAbgeschlossenAm).HasColumnName("onboarding_abgeschlossen_am")
                  .HasColumnType("timestamp without time zone");
            entity.Property(e => e.OnboardingAbgeschlossenVon).HasColumnName("onboarding_abgeschlossen_von");
